...
-keep class * extends com.kr.musicplayer.ui.adapter.holder.BaseViewHolder{*;}

-keep class **.R$* {*;}
-keep public class com.kr.musicplayer.R$*{
public static final int *;
}
-keepclassmembers class ** {
    @com.kr.musicplayer.misc.handler.OnHandleMessage public *;
}
